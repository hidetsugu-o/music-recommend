...
## 目次
  - [利用方法](#利用方法)
  - [目指した課題解決](#目指した課題解決)
  - [要件定義（長いので読み飛ばしていただいてOKです）](#要件定義長いので読み飛ばしていただいてokです)
  - [実装した機能についてのGIFと説明](#実装した機能についてのgifと説明)
  - [今後の実装予定](#今後の実装予定)
  - [データベース設計](#データベース設計)
  - [アプリ開発環境](#アプリ開発環境)
...
##### 【表示】
- ログイン状態関係なく表示
  - カルーセルで、過去の投稿のうち3件がピックアップ表示される
  - グループ全体での最新の投稿が、新しい順で6件表示される
- ログイン後
  - ユーザーの一覧が表示される
