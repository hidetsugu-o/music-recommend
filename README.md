...
#### アカウントの削除方法
- 画面右上のメニューボタン（画像の矢印）から、アカウントの削除を選択してください。
  - 自身の投稿、イイねも全て一緒に削除されます。

![IMG_3784 (1)](https://user-images.githubusercontent.com/74892038/105569431-dd9c3400-5d84-11eb-8931-84d339319508.jpg)
