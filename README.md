...
- LINEを使って、YouTube上のオススメ楽曲を紹介しあっているグループ
  - 初オリジナルアプリ開発ということもあり、まずは課題がイメージしやすい、自分含む身近な人をターゲットにしました。
#### どのような課題を？
- 過去に投稿されたオススメ楽曲を、後からまとめて振り返ることができたら楽しそう！
  - LINEのトークルームはメッセージが流れてしまうので、もったいないと感じていました。
- 投稿一覧をユーザー毎にまとめて表示することで、みんなの投稿の傾向を知れたら面白い！！
  - 収集したデータを、上記のように有効活用できるのがこのアプリの意義になると考えました。
- スマホでも見やすく！！！
  - LINEからこのアプリへの動線をスムーズにするため、ここはマストと考えました。
